    ...
    return (
        <>
            ...
            <Row>
                ...
                <Col span={12}> <Statistic title="Total 24hour Volume" value={millify(globalStatus.total24hVolume)}/></Col>
                <Col span={12}> <Statistic title="Total Markets" value={millify(globalStatus.totalMarkets)}/></Col>
            </Row>
            <div className='home-heading-container'>
                <Title level={2} className="home-title">Top10 crypto currencies</Title>
