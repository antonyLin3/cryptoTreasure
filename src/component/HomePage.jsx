...
const HomePage = () => {
    ...
    return (
        <>
            ...
            <Row>
                <Col className="homepage-col" span={12}> <Statistic title="加密貨幣總量" value={globalStatus?.total}/></Col>
                <Col className="homepage-col" span={12}> <Statistic title="交易所總量" value={millify(globalStatus?.totalExchanges)}/></Col>
                <Col className="homepage-col" span={12}> <Statistic title="加密貨幣總市值" value={millify(globalStatus?.totalMarketCap)}/></Col>
                <Col className="homepage-col" span={12}> <Statistic title="24小時成交量" value={millify(globalStatus?.total24hVolume)}/></Col>
                <Col className="homepage-col" span={12}> <Statistic title="加密貨幣總市場" value={millify(globalStatus?.totalMarkets)}/></Col>
            </Row>
